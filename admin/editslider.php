...
if(isset($_GET['id'])) {
    ...
    $show_query = "select * from tbl_sliders where id = $id";
...
<?php 
    if(isset($_POST['update'])) {
        ...
        $edit_query = "UPDATE tbl_sliders SET title = '$title', description = '$description', img_link ='$img_link', btn_link ='$btn_link' where id = '$id'";
...
<div class="alert alert-success" id="success-alert" role="alert">
  ...
  else 
  {
    ?>
                          ...
                          <strong>Slider couldn't be updated successfully.</strong> 
            ...
            <div class="card-body">
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"class="form-control" name="btn_link" id="" value ="<?php echo $btn_link; ?>"> 
                    </div>
