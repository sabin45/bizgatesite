...
if(isset($_POST['submit'])){
    ...
    if($title!== "" && $description!=="" && $img_link!==""){
        $create_query = "INSERT INTO tbl_whychooseus (title,description,img_link,icon_link,feature_title,feature_desc) VALUES ('$title','$description','$img_link','$icon_link','$feature_title','$feature_details')";
        ...
        <div class="alert alert-success alert-dissmissible fade show" id="success-alert">
            ...
            <strong>Why Choose Us Created </strong> successfully.
        </div>
                    ...
                    <!-- form started -->
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">                               
                                    ...
                                    <input type="text" id ="icon" class="form-control" name="icon_link" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="">Feature Title </label>
                                    <input type="text"class="form-control" name="feature_title" id="" placeholder=""> 
                                </div>
                                <div class="form-group mb-3">                               
                                    <label for="">Feaure Details </label>
                                    <input type="text" id ="imagebox" class="form-control" name="feature_details" placeholder="">
                                </div>
