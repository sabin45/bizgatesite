            ...
            <?php
                if(isset($_POST['submit'])) {
                    ...
                    if($title!="" && $description!="" && $img_link!="") {
                        $create_query = "INSERT INTO tbl_services (title,description,img_link,sub_title,details) VALUES('$title','$description','$img_link','$sub_title','$details')";
                            ...
                            <div class="alert alert-success alert-dismissible fade show" id="success-alert">
                                ...
                                <meta http-equiv="refresh" content="0; URL=manageservices.php?msg=success" />
                                        ...
                                        ?>
                                            ...
                                            <strong>Services page couldn't be created successfully.</strong> 
            ...
            <div class="card-body">
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"class="form-control" name="sub_title" id="" placeholder=""> 
                    </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="firstFunction()" data-bs-dismiss="modal">Select</button>
                    ...
                    <div class="form-group mb-3">                               
                        ...
                        <input type="text" id ="imagebox" class="form-control" name="details" placeholder="">
                    </div>
