...
if(isset($_GET['id'])) {
    ...
    $show_query = "select * from tbl_posts where id = $id";
...
<?php 
    if(isset($_POST['update'])) {
        ...
        $update_query = "UPDATE tbl_posts SET title = '$title', description = '$description', img_link ='$img_link' where id = '$id'";
        $edit_result = mysqli_query($conn,$update_query);
            ...
            <div class="card-body">
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="editor1"  value =""><?php echo $description; ?></textarea>
                    </div>
