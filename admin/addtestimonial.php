...
if(isset($_POST['submit'])){
    ...
    if($name!== "" && $description!=="" && $img_link!=="" && $occupation!==""){
        $create_query = "INSERT INTO tbl_testimonials (name,occupation,description,img_link) VALUES ('$name','$occupation','$description','$img_link')";
        ...
        <div class="alert alert-success alert-dissmissible fade show" id="success-alert">
            ...
            <strong>Testimonials Added </strong> successfully.
        </div>
                    ...
                    <!-- form started -->
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">                               
                                    ...
                                    <input type="text" id ="icon" class="form-control" name="occupation" placeholder="">
                                </div>
